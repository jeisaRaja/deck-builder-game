...
func on_input(event: InputEvent) -> void:
	...
	var mouse_bottom := card_ui.get_global_mouse_position().y > MOUSE_Y_SNAPBACK_THRESHOLD
	if (mouse_motion and mouse_bottom) or event.is_action_pressed("right_mouse"):
